...
Este laboratório demonstra um dos recursos mais poderosos do kernel Linux: o **XDP (eXpress Data Path)**. Ao anexar um pequeno programa eBPF diretamente a uma interface de rede, é possível descartar pacotes **antes mesmo que eles cheguem à pilha de rede**, tornando a filtragem praticamente gratuita em termos de CPU.
